...
```bash
curl --insecure -H "X-Data-Collector-Token: token-value" https://automate.tastyworks.com/api/v0/compliance/profiles/search -d '{"owner": "test"}'
```

#### Get All Available Profiles

```bash
curl --insecure -H "X-Data-Collector-Token: token-value" https://automate.tastyworks.com/api/v0/compliance/profiles/search -d '{}'
```
